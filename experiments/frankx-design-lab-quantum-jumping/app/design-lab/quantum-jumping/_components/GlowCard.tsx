...
interface GlowCardProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  glowColor?: string // e.g. 'rgba(139, 92, 246, 0.18)'
}

/**
 * Quantum Jumping GlowCard — liquid-glass card with a cursor-following radial
 * glow. Self-contained (co-located under the quantum-jumping route) so it does
 * not collide with the site's shared GlowCard component.
 */
