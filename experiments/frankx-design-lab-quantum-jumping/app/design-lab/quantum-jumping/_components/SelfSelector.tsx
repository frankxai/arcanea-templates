  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="mx-auto max-w-4xl">
        {/* Segmented selector */}
        <div role="tablist" aria-label="Choose a parallel self" className="flex flex-wrap justify-center gap-2 mb-10">
          {SELVES.map((self) => {
            ...
            return (
              ...
              >
                ...
                <Icon className="relative h-4 w-4" style={{ color: isActive ? self.tint : undefined }} />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div>
                ...
                <h3 className="qj-font-editorial text-3xl sm:text-4xl text-zinc-100 mb-4">{active.label}</h3>
                <p className="text-zinc-400 text-base leading-relaxed max-w-xl">{active.body}</p>
                <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-black/30 px-3.5 py-1.5 qj-font-mono text-xs text-zinc-400">
