...
const LINES: LogLine[] = [
  ...
  },
  {
    ...
    body: (
      <>
        Portal stabilised. Threshold luminance{' '}
        <span className="text-zinc-100">96%</span>.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Crossing. Parallel self located — timeline{' '}
        <span className="text-zinc-100">Δ-4417</span>.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Skill signature acquired →{' '}
        <span className="text-zinc-400">&ldquo;finished the work&rdquo;</span>.
      </>
    ),
  },
  {
    ...
    <LazyMotion features={domAnimation}>
      <LiquidGlass tint="#8b5cf6" intensity="heavy" className="w-full">
        <div className="p-8">
          <div className="flex items-center justify-between border-b border-white/[0.08] pb-6 mb-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs text-zinc-400">
                jump-session://voyager-07 · theta locked
              </span>
            </div>
          ...
          <m.div
            className="font-mono text-xs text-zinc-300 space-y-4"
            variants={container}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <m.div variants={line} className="flex items-start gap-4">
              ...
              <div className="text-zinc-500">
                session closed
                <span className="animate-blink text-violet-300 ml-0.5">▌</span>
              </div>
            </m.div>
          </m.div>
        </div>
